...
```{r}
dt.mcmc <- extract_summary_statistics(fit.mcmc, ntrials=opts$ntrials, params = "theta") %>%
  .[,inference:="MCMC"] 
dt.vb <- extract_summary_statistics(fit.vb, ntrials=opts$ntrials, params = "theta") %>%
  .[,inference:="ADVI"] 
...
Extract summary statistics
```{r}
dt.mcmc <- extract_summary_statistics(fit.mcmc, ntrials=opts$ntrials, params = "w") %>%
  .[,inference:="MCMC"] 
dt.vb <- extract_summary_statistics(fit.vb, ntrials=opts$ntrials, params = "w") %>%
  .[,inference:="ADVI"] 
